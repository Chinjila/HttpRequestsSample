...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        // </snippet_AddHttpClientBasic>
        builder.Services.AddSingleton<ISingletonHttp>(new SingletonHttpClient());
        ...
        builder.Services.AddHttpClient("GitHubAspnetCoreRepoBranch", httpClient =>
        {
            httpClient.BaseAddress = new Uri("https://api.github.com/repos/dotnet/AspNetCore.Docs/branches");
        ...
        builder.Services.AddHttpClient("FootballClient", httpClient =>
        {
            httpClient.BaseAddress = new Uri("https://api-football-v1.p.rapidapi.com/v3/leagues");
